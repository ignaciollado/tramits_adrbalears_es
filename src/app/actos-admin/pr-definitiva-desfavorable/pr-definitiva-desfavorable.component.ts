...
@Component({
  ...
  templateUrl: './pr-definitiva-desfavorable.component.html',
...
private expedienteService = inject(ExpedienteService)
  ...
  getActoAdminDetail() {
    this.documentosGeneradosService.getDocumentosGenerados(this.actualID, this.actualNif, this.actualConvocatoria, 'doc_prop_res_def_desfavorable_sin_req')
      .subscribe({
  ...
  generarPDF(jsonObject: any, docFieldToUpdate: string, hayMejoras: number): void {
    ...
    doc.setFontSize(10);
    doc.text(doc.splitTextToSize(jsonObject.antecedentes_5_8, maxTextWidth), marginLeft + 5, 60);
