...
private expedienteService = inject(ExpedienteService)
  ...
  actoAdminName: string = "doc_resolucion_denegacion_sin_requerimiento"
  ...
  generarPDF(jsonObject: any, docFieldToUpdate: string, hayMejoras: number): void {
    ...
    doc.setFont('helvetica', 'normal');
    doc.text(doc.splitTextToSize(jsonObject.antecedentes_1_6, maxTextWidth), marginLeft + 5, 140);
