...
@Component({
  selector: 'app-declaracion-responsable',
  standalone: true,
...
export class DeclaracionResponsableComponent {
  ...
  getDeclaracionResponsable(): void {
    this.documentoGeneradoService.getDocumentosGenerados(this.actualID, this.actualNif, this.actualConvocatoria, 'doc_dec_res_solicitud')
      .subscribe({
