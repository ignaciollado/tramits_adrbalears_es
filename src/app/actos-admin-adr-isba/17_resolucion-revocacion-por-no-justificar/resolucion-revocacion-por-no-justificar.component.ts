...
export class ResolucionRevocacionPorNoJustificarAdrIsbaComponent implements OnChanges {
  ...
  saveReasonRevocation(): void {
    ...
    if (this.formRevocacion.valid) {
      ...
      this.documentoGeneradosService.deleteByIdSolNifConvoTipoDoc(this.actualID, this.nifDocGenerado, this.actualConvocatoria, 'doc_resolucion_revocacion_no_justificar').subscribe({
