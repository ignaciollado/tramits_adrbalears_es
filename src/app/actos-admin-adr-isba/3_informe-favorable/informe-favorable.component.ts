...
import { InformeFavorableAdrIsbaService } from '../../Services/adr-isba-actos-admin/3-informe-favorable/informe-favorable.service';
...
export class InformeFavorableAdrIsbaComponent {
  private informeFavorableService = inject(InformeFavorableAdrIsbaService);
