...
import { ResolDesestimientoNoEnmendarIlsService } from '../../Services/ils-actos-admin/2-resol-desestimiento-no-enmendar/resol-desestimiento-no-enmendar.service';
...
export class ResolDesestimientoNoEnmendarIlsComponent {
  private resolDesestimientoNoEnmendarService = inject(ResolDesestimientoNoEnmendarIlsService);
