...
@Component({
  selector: 'app-resol-desestimiento-no-enmendar-ils',
  standalone: true,
...
export class ResolDesestimientoNoEnmendarIlsComponent {
  ...
  ngOnInit(): void {
    this.actoAdminService.getByNameAndTipoTramite('ILS_2_resolucion_desestimiento_no_enmendar', 'ILS')
