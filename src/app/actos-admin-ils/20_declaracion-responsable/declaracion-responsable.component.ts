...
export class DeclaracionResponsableIlsComponent {
  ...
  getDeclaracionResponsable(): void {
    this.documentoGeneradoService.getDocumentosGenerados(this.actualID, this.actualNif, this.actualConvocatoria, 'doc_declaracion_responsable_ils')
      .subscribe({
